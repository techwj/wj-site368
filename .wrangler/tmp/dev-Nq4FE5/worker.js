...
function generateMetaTags(pageData = {}) {
  ...
  const defaultDescription = "Create beautiful QR codes with AI-generated backgrounds. Free online tool for websites, marketing, and social media campaigns.";
      ...
      if (path === "/api/models") {
        ...
        try {
          ...
          if ("url" in data && "style" in data) {
            ...
            try {
              ...
              const svgString = await import_qrcode.default.toString(data.url, {
                type: "svg",
                width: 300,
                margin: 1,
        ...
        if (baseDomain !== currentDomain) {
          const pageData = {
            ...
            description: "Create beautiful QR codes with AI-generated backgrounds. Free online tool for websites, marketing, and social media campaigns.",
